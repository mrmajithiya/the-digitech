...
const Project1 = () => {
    ...
    const chooseContent = [
        {img:'/assets/img/newimgs/Screenshot(1).png'},
        {img:'/assets/img/newimgs/Screenshot(2).png'},
        {img:'/assets/img/newimgs/Screenshot(3).png'},
        {img:'/assets/img/newimgs/Screenshot(4).png'},
        {img:'/assets/img/newimgs/Screenshot(5).png'},
        {img:'/assets/img/newimgs/Screenshot(8).png'},
      ]; 
