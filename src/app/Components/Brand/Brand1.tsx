...
const Brand1 = () => {
    ...
    const chooseContent = [
        {img:'/assets/img/newimgs/logo-procurve.png'},
        {img:'/assets/img/newimgs/Karmyog-logo.webp'},
        {img:'/assets/img/newimgs/AVISHKAR-logo.png'},
        {img:'/assets/img/newimgs/metsterr_logo.webp'},
        {img:'/assets/img/newimgs/Untitled_design_8.avif'},
      ]; 
