        ...
        <div className="container">
          <div className="cs_hero_content">
            <div className="cs_hero_thumbnail wow fadeInLeft">
              <Image src="/assets/img/newimgs/Frame_1707.png" className="object-contain" alt="img" width={916} height={473}   />
            ...
            <div className="cs_hero_text position-relative">
              ...
              <h1 className="cs_hero_title cs_extra_bold wow fadeInDown" style={{ color: '#022179' }}>Digital  Marketing <span className="cs_accent_color cs_semibold" style={{ color: '#ff1505' }}>Solutions.</span></h1>
