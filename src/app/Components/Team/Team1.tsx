...
const Team1 = () => {
    ...
    const teamContent = [
        {img:'/assets/img/team_2.jpg', name:'Nirav Prajapati', content:'Founder & CEO',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_1.jpg', name:'Hemant Bhadarka', content:'Bhagvan',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_3.jpg', name:'Janki', content:'BDE',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_4.jpg', name:'om', content:'Senior Developer',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_4.jpg', name:'mahima', content:'Marketing',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_4.jpg', name:'jensi', content:'Dogiotal Marketing',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_4.jpg', name:'jainil', content:'Shoot',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/team_4.jpg', name:'abc', content:'ABC',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
      ];
